...
public class NetworkConnector {
    ...
    public static final int GET_BOOKS_OF_WATTPAD_JSON_REQ = 5;

    public static final int INSERT_BOOK_REQ = 6;
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST, reqUrl, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        notifyBookUpdateListener(response, ResStatus.SUCCESS, listener);
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        try {
                            ...
                            notifyBookUpdateListener(err, ResStatus.FAIL, listener);
                        }
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, reqUrl,
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            notifyBookUpdateListener(obj, ResStatus.SUCCESS, listener);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        try {
                            ...
                            notifyBookUpdateListener(obj, ResStatus.FAIL, listener);
                        }
            ...
            * */
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(BOOK_ID, item.getId());
                params.put(BOOK_NAME, item.getName());
                params.put(BOOK_DESCRIPTION,  item.getDescription());
                params.put(BOOK_CONTENT,  item.getContent());
                params.put(WATTPAD_ID, item.getWattpadId());
                return params;
            }
            ...
            * */
            ...
            protected Map<String, DataPart> getByteData() {
                ...
                byte[] pic = BookInfo.getImgAsByteArray(item.getImage());
    ...
    public void sendRequestToServer(int requestCode, BookInfo data, NetworkResListener listener){
    ...
    private  void notifyPostBitmapUpdateListener(final Bitmap res, final ResStatus status, final NetworkResListener listener) {
        ...
        Runnable myRunnable = new Runnable() {
            ...
            public void run() {
                try{
                    listener.onBookUpdate(res, status);
                }
                catch(Throwable t){
                    t.printStackTrace();
                }
    ...
    private  void notifyBookUpdateListener(final JSONObject res, final ResStatus status, final NetworkResListener listener) {
